...
//		LinkedListUtils.displayLinkedList(sum2);
		...
		ListNode<Integer> l5 = LinkedListUtils.buildList(0);
		ListNode<Integer> l6 = LinkedListUtils.buildList(9,9);
		LinkedListUtils.displayLinkedList(l5);
		LinkedListUtils.displayLinkedList(l6);
		
		ListNode<Integer> sum3 = solution.addLists(l5, l6);
		System.out.println();
     ...
     */
    public ListNode<Integer> addLists(ListNode<Integer> l1, ListNode<Integer> l2) {
        ...
        while (cur1 != null && cur2 != null) {
        	...
        	if (result == null) {
        		result = new ListNode<Integer>(currentDigit);
        		cur = result;
        	} else {
        		cur.next = new ListNode<Integer>(currentDigit);
        		cur = cur.next;
        	}
